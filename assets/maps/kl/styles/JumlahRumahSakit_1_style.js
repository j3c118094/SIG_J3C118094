...
var style_JumlahRumahSakit_1 = function(feature, resolution){
    ...
    if (value >= 0.000000 && value <= 17.000000) {
        ...
        stroke: new ol.style.Stroke({color: 'rgba(35,35,35,0.8)', lineDash: null, lineCap: 'butt', lineJoin: 'miter', width: 0}),fill: new ol.style.Fill({color: 'rgba(253,149,97,0.8)'}),
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 34.000000 && value <= 54.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 54.000000 && value <= 101.000000) {
            style = [ new ol.style.Style({
